...
class RemoteUserInfoRepository @Inject constructor(
    ...
    override fun updateUserProfileImage(image: ResizableImage): Flow<ImageUploadProgress> =
        channelFlow {
            ...
            val fetchUrlRequest = processResponseOnResponseData(
