...
constructor(
    ...
    internal val uiState: StateFlow<SellerRegisterUiState> = _uiState
    ...
    private fun checkBasicInfoPageFieldsAndProcess() {
        ...
        val telState = if (_uiState.value.form.tel.length < 10) {
            hasError = true
            FormError.EmptyField
        } else {
            FormError.None
    ...
    private fun checkLocationInfoPageFieldsAndProcess() {
        ...
        val addressState = if (_uiState.value.form.address.isEmpty()) {
            hasError = true
            FormError.EmptyField
        } else {
            FormError.None
    ...
    private fun checkAccountInfoPageFieldsAndProcess() {
        ...
        val accountNumberState = if (_uiState.value.form.accountNumber.isEmpty()) {
            hasError = true
            FormError.EmptyField
        } else {
            FormError.None
    ...
    fun onSecondPageFormChanged(address: String, description: String) {
        _uiState.value =
            _uiState.value.copy(
                form =
                    _uiState.value.form.copy(
    ...
    fun onThirdPageFormChanged(accountOwner: String, accountNumber: String) {
        _uiState.value =
            _uiState.value.copy(
                form =
                    _uiState.value.form.copy(
